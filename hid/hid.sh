...
\\x29\\x65\
\\x81\\x00\
\\xc0 > functions/hid.$A_N/report_desc

# Relative Mouse, 3 button & wheel
B_N="mouse"
...
\\x95\\x03\
\\x81\\x06\
\\xc0\\xc0 > functions/hid.$B_N/report_desc


# Absolute mouse, 3 button
C_N="mouse2"
...
\\x95\\x02\
\\x81\\x02\
\\xc0\\xc0 > functions/hid.$C_N/report_desc
